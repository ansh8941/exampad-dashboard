...
const InnerWrapperStyle = styled('div')(({ theme }) => ({
  '@media (min-width: 0px)': {
    alignItems: 'center',
    paddingTop: '40px',
    paddingBottom: '40px',
...
const DescStyle = styled(Typography)(({ theme }) => ({
  margin: '0px',
  lineHeight: 1.57143,
  fontSize: '0.875rem',
  fontFamily: '"Public Sans", sans-serif',
...
const SvgBoxStyle = styled(Box)(({ theme }) => ({
  padding: '24px',
  width: '360px',
  '@media (min-width: 0px)': {
    marginBottom: 'auto',
...
const BackgroundStyle = styled('div')(({ theme }) => ({
  ...
  '&:before': {
    ...
    content: '""',
    opacity: 0.2,
    background: 'linear-gradient(135deg, rgb(104, 205, 249), rgb(7, 141, 238))',
  },
}));
...
export default function AppWelcome() {
  return (
    <WrapperStyle>
      <InnerWrapperStyle>
        <TitleStyle paragraph={true} variant="h4">
          Welcome back! <br /> Minimal UI
        </TitleStyle>

        <DescStyle variant="body2">
        ...
        <svg width="100%" height="100%" viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="BG" x1="19.496%" x2="77.479%" y1="71.822%" y2="16.69%">
              <stop offset="0%" stopColor="#078DEE"></stop>
              <stop offset="100%" stopColor="#078DEE" stopOpacity="0"></stop>
            </linearGradient>
          </defs>
          <path
            fill="url(#BG)"
          ...
          <path fill="#0351AB" d="M117.435 95.279l7.051-6.947L151.154 76l-28.905 7.727-4.814 11.552z"></path>
          <defs>
            <filter
              id="filter0_f_1_51"
              width="101.56"
            ...
            >
              ...
              <stop offset="1" stopColor="#0351AB"></stop>
            </linearGradient>
            <linearGradient
          ...
          <image
            href="https://minimals.cc/assets/illustrations/characters/character_3.png"
            height="300"
            x="312"
            y="30"
          ></image>
